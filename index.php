...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class=" py-5">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted"> 2023 - <?php echo $_SESSION['system']['name'] ?> | <a class="text-success" href="https://www.sourcecodester.com/" target="_blank"></a></div></div>
        </footer>
